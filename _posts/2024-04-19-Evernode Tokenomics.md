...
In addition to earning EVR through running Evernode Hosts, users can acquire EVR tokens through various trading options available in the cryptocurrency market. EVR tokens are currently listed on [BitTrue](https://www.bitrue.com/trade/evr_usdt) and [BitMart](https://www.bitmart.com/trade/en-US?symbol=EVR_USDT) exchanges and can be traded like any other currency.

<center><img src="/img/hn-3-2024-04-19.png" height="177 px" width="750 px"  /></center>

The self-custodial [Xaman wallet](https://xumm.app/) specifically designed for the XRP Ledger and Xahau is the recommended wallet app to store EVR tokens.
