...
|Votes are tallied, and outcomes are implemented automatically without a trusted intermediary.	If voting is allowed, votes are tallied internally, and the outcome of voting must be handled manually. |If voting is allowed, votes are tallied internally, and the outcome of voting must be handled manually. |
