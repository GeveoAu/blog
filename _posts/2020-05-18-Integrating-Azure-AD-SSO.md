...
\* In \*\*Implicit grant\*\* section enable \*\*Access tokens\*\* and \*\*Id
tokens\*\* and save the changed settings
...
\* From side panel go to \*\*Overview\*\* and copy the \*\*Application (client)
ID\*\* and \*\*Directory (tenant) ID\*\* values
...
\# \*Congratulations!! You have integrated SSO authentication for your
application.\*
...
\* \*\*To access GraphAPI all you need are following which have already copied
from App Registration step. As I said early it’s better you added those to your
.config file\*\*
...
\* \*\*Now we are going to initiate a GraphApi client to access the Active
Directory\*\*

\<img src="/img/Chalith13.png" width="600" height="300" /\>

\* \*\*Simple as that you just initiated a graph client. Now the hard part is
done let’s play with Active Directory\*\*
...
\* \*\*Here you might be wondering why we are using CurrentPage. It’s because
the response comes as pages. So you need to get User objects from the page.
You’ll see this in next example too.\*\*
